...
export default function AnimatedBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* orb 1 - crimson */}
      <motion.div
        className="absolute -top-32 -left-32 w-130 h-130 rounded-full blur-[90px] opacity-30"
      ...
      {/* orb 2 - gold */}
      <motion.div
        className="absolute -bottom-40 -right-32 w-160 h-160 rounded-full blur-[100px] opacity-20"
      ...
      {/* orb 3 - deep rose */}
      <motion.div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-225 h-120 rounded-full blur-[110px] opacity-15"
