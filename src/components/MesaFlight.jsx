...
export default function MesaFlight({ onDone }) {
  ...
  useEffect(() => {
    ...
    { p:[-0.42, 0.13, 0.93], s:0.50, d:[-0.26, 0.60, 0.70] },
        ...
        const sprigDefs = [
          [ 0.26, 0.14, 0.12],[-0.26, 0.14, 0.16],[ 0.60, 0.10, 0.60],[-0.60, 0.10, 0.58],
          [ 0.16, 0.17, 0.70],[-0.14, 0.16, 0.72],[ 0.82, 0.08, 0.10],[-0.82, 0.08, 0.12],
          [ 0.45, 0.08, 1.00],[-0.45, 0.08, 0.98],[ 0.05, 0.18, 0.32],[ 0.86, 0.10, 0.78],
        ]
