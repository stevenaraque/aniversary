        ...
        <div className="container-lg relative z-10 grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-6 lg:gap-14 items-center w-full px-6 lg:px-8 py-8">
          ...
          <motion.div initial={{opacity:0,scale:0.97,filter:'blur(8px)'}} animate={{opacity:1,scale:1,filter:'blur(0px)'}} transition={{...springs.gentle,delay:0.6}} className="order-2 w-full h-auto flex items-center justify-center p-2 lg:p-0 max-w-full overflow-hidden">
            ...
            <div className="gothic-prism">
              ...
              <div className="corner corner-tl"><svg viewBox="0 0 70 70" fill="none"><path d="M2 68 L2 8 Q2 2 8 2 L24 2" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M2 68 L68 68 Q68 68 68 62 L68 48" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M8 8 Q12 2 18 8 Q12 14 8 8Z" fill="rgba(212,175,55,0.2)" stroke="rgba(212,175,55,0.4)" strokeWidth="0.5"/><circle cx="14" cy="14" r="1" fill="rgba(220,38,38,0.5)"/></svg></div>
              <div className="corner corner-tr"><svg viewBox="0 0 70 70" fill="none"><path d="M2 68 L2 8 Q2 2 8 2 L24 2" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M2 68 L68 68 Q68 68 68 62 L68 48" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M8 8 Q12 2 18 8 Q12 14 8 8Z" fill="rgba(212,175,55,0.2)" stroke="rgba(212,175,55,0.4)" strokeWidth="0.5"/><circle cx="14" cy="14" r="1" fill="rgba(220,38,38,0.5)"/></svg></div>
              <div className="corner corner-bl"><svg viewBox="0 0 70 70" fill="none"><path d="M2 68 L2 8 Q2 2 8 2 L24 2" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M2 68 L68 68 Q68 68 68 62 L68 48" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M8 8 Q12 2 18 8 Q12 14 8 8Z" fill="rgba(212,175,55,0.2)" stroke="rgba(212,175,55,0.4)" strokeWidth="0.5"/><circle cx="14" cy="14" r="1" fill="rgba(220,38,38,0.5)"/></svg></div>
              <div className="corner corner-br"><svg viewBox="0 0 70 70" fill="none"><path d="M2 68 L2 8 Q2 2 8 2 L24 2" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M2 68 L68 68 Q68 68 68 62 L68 48" stroke="rgba(212,175,55,0.6)" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M8 8 Q12 2 18 8 Q12 14 8 8Z" fill="rgba(212,175,55,0.2)" stroke="rgba(212,175,55,0.4)" strokeWidth="0.5"/><circle cx="14" cy="14" r="1" fill="rgba(220,38,38,0.5)"/></svg></div>
