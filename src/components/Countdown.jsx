  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        >
          <span className="text-gradient-blood">Tiempo</span>{' '}
          <span className="text-white">juntos</span>
        </motion.h2>

        <motion.p
          className="text-crimson/40 mb-12 text-sm flex items-center justify-center gap-3 tracking-wider uppercase"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.3, duration: motionTokens.duration.slow }}
        >
          <BatIcon className="w-4 h-4" />
          Desde el 24 de agosto de 2024
          <BatIcon className="w-4 h-4" />
        </motion.p>
        {/* AnimatedNumber simplified - no spring needed */}
        ...
        <motion.p
          className="text-white/20 text-sm mb-10 italic"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
